...
class CompanySettings(Base):
    ...
    id = Column(Integer, primary_key=True, index=True)
    company_name = Column(String, default="SKY ARIANA GROUP OF COMPANIES", nullable=False)
    subtitle = Column(String, default="IMPORT • EXPORT • LOGISTICS • CARGO • FREIGHT", nullable=False)

...
<head>
    <meta charset="utf-8">
    <title>SAFTA Certificate <?php echo e($certificate->reference_no ?: $certificate->certificate_no); ?></title>
    <style>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.acci.safta-document','data' => ['certificate' => $certificate,'forPdf' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['certificate' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($certificate),'for-pdf' => true]); ?>
...
<?php /**PATH E:\New folder\sky-ariana-bbb\acci-laravel\resources\views/safta-certificates/pdf.blade.php ENDPATH**/ ?>
...
@section('title', 'Sky Ariana & Balam Bar Baran — Main Logistics Suite')
        ...
        <div class="card-body p-4 p-md-5">
            <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
                ...
                <div class="d-flex flex-column gap-2">
                    <a href="{{ env('MAIN_LOGISTICS_URL', 'http://127.0.0.1:5173') }}" target="_top" class="btn btn-primary fw-bold px-4 py-2.5 shadow-sm d-flex align-items-center justify-content-center gap-2" style="background: linear-gradient(135deg, #1e3a8a, #2563eb); border: none;">
                        <span>🚀</span> <span>Open Main Logistics Software</span>
                    </a>
                    <a href="{{ route('safta-certificates.create') }}" class="btn btn-warning fw-bold px-4 py-2.5 shadow-sm d-flex align-items-center justify-content-center gap-2 text-dark" style="background: linear-gradient(135deg, #fbbf24, #f59e0b); border: none;">
                        <span>📜</span> <span>+ New SAFTA Certificate</span>
                    </a>
                    <a href="{{ route('acci-invoices.create') }}" class="btn btn-dark fw-bold px-4 py-2.5 shadow-sm d-flex align-items-center justify-content-center gap-2 text-white" style="background: #0f172a; border: none;">
                        <span>📄</span> <span>+ New Commercial Invoice</span>
                    </a>
                    <a href="{{ route('company-stamps.index') }}" class="btn btn-outline-secondary fw-bold px-4 py-2.5 shadow-sm d-flex align-items-center justify-content-center gap-2" style="background: white; border: 1px solid #cbd5e1; color: #475569;">
    ...
    <div class="row g-3 mb-4">
        <div class="col-6 col-md-4 col-xl-2-4" style="flex: 1 0 18%; min-width: 180px;">
            <div class="card border-0 shadow-sm h-100 p-3 bg-white" style="border-radius: 1.1rem; border: 1px solid #e2e8f0 !important; border-top: 3px solid #2563eb !important; transition: transform 0.2s, box-shadow 0.2s;">
                ...
                <div class="fs-3 fw-bold text-dark mb-1" style="letter-spacing: -0.02em;">{{ number_format($counts['invoices']) }}</div>
        ...
        <div class="col-6 col-md-4 col-xl-2-4" style="flex: 1 0 18%; min-width: 180px;">
            <div class="card border-0 shadow-sm h-100 p-3 bg-white" style="border-radius: 1.1rem; border: 1px solid #e2e8f0 !important; border-top: 3px solid #10b981 !important; transition: transform 0.2s, box-shadow 0.2s;">
                ...
                <div class="fs-3 fw-bold text-dark mb-1" style="letter-spacing: -0.02em;">{{ number_format($counts['packing_lists']) }}</div>
                <div class="d-flex align-items-center justify-content-between">
        ...
        <div class="col-6 col-md-4 col-xl-2-4" style="flex: 1 0 18%; min-width: 180px;">
            <div class="card border-0 shadow-sm h-100 p-3 bg-white" style="border-radius: 1.1rem; border: 1px solid #e2e8f0 !important; border-top: 3px solid #06b6d4 !important; transition: transform 0.2s, box-shadow 0.2s;">
                ...
                <div class="fs-3 fw-bold text-dark mb-1" style="letter-spacing: -0.02em;">{{ number_format($counts['air_waybills']) }}</div>
                <div class="d-flex align-items-center justify-content-between">
        ...
        <div class="col-6 col-md-4 col-xl-2-4" style="flex: 1 0 18%; min-width: 180px;">
            <div class="card border-0 shadow-sm h-100 p-3" style="border-radius: 1.1rem; border: 1px solid #fde68a !important; border-top: 3px solid #f59e0b !important; background: linear-gradient(135deg, #ffffff 0%, #fffef5 100%); transition: transform 0.2s, box-shadow 0.2s;">
                ...
                <div class="fs-3 fw-bold text-dark mb-1" style="letter-spacing: -0.02em;">{{ number_format($counts['safta_certificates']) }}</div>
                <div class="d-flex align-items-center justify-content-between">
        ...
        <div class="col-6 col-md-4 col-xl-2-4" style="flex: 1 0 18%; min-width: 180px;">
            <div class="card border-0 shadow-sm h-100 p-3 bg-white" style="border-radius: 1.1rem; border: 1px solid #e2e8f0 !important; border-top: 3px solid #64748b !important; transition: transform 0.2s, box-shadow 0.2s;">
                ...
                <div class="fs-3 fw-bold text-dark mb-1" style="letter-spacing: -0.02em;">{{ number_format($counts['shipping_stickers']) }}</div>
                <div class="d-flex align-items-center justify-content-between">
            ...
            <div class="card border-0 shadow-sm h-100 overflow-hidden d-flex flex-column bg-white" style="border-radius: 1.25rem; border: 1px solid #e2e8f0 !important; border-top: 4px solid #f59e0b !important; transition: all 0.25s cubic-bezier(0.16, 1, 0.3, 1);">
                <div class="card-body p-4 d-flex flex-column">
                    ...
                    <div class="d-flex gap-2 mt-auto">
                        <a href="{{ route('safta-certificates.index') }}" class="btn btn-outline-dark fw-bold flex-grow-1 py-2" style="border-radius: 0.65rem;">
                            Manage Suite →
                        </a>
                        <a href="{{ route('safta-certificates.create') }}" class="btn btn-warning fw-bold px-3 py-2 text-dark" style="border-radius: 0.65rem; background: linear-gradient(135deg, #fbbf24, #f59e0b); border: none;">
                            + New
                        </a>
                    </div>
                </div>
        ...
        <div class="col-12 col-md-6 col-lg-4">
            <div class="card border-0 shadow-sm h-100 overflow-hidden d-flex flex-column bg-white" style="border-radius: 1.25rem; border: 1px solid #e2e8f0 !important; border-top: 4px solid #2563eb !important; transition: all 0.25s cubic-bezier(0.16, 1, 0.3, 1);">
                <div class="card-body p-4 d-flex flex-column">
                    ...
                    <div class="d-flex gap-2 mt-auto">
                        <a href="{{ route('acci-invoices.index') }}" class="btn btn-outline-dark fw-bold flex-grow-1 py-2" style="border-radius: 0.65rem;">
                            Manage Invoices →
                        </a>
                        <a href="{{ route('acci-invoices.create') }}" class="btn btn-primary fw-bold px-3 py-2" style="border-radius: 0.65rem; background: linear-gradient(135deg, #1e3a8a, #2563eb); border: none;">
                            + New
                        </a>
                    </div>
                </div>
        ...
        <div class="col-12 col-md-6 col-lg-4">
            <div class="card border-0 shadow-sm h-100 overflow-hidden d-flex flex-column bg-white" style="border-radius: 1.25rem; border: 1px solid #e2e8f0 !important; border-top: 4px solid #10b981 !important; transition: all 0.25s cubic-bezier(0.16, 1, 0.3, 1);">
                <div class="card-body p-4 d-flex flex-column">
                    ...
                    <div class="d-flex gap-2 mt-auto">
                        <a href="{{ route('acci-packing-lists.index') }}" class="btn btn-outline-dark fw-bold flex-grow-1 py-2" style="border-radius: 0.65rem;">
                            Manage Packing →
                        </a>
                        <a href="{{ route('acci-packing-lists.create') }}" class="btn btn-success fw-bold px-3 py-2" style="border-radius: 0.65rem; background: linear-gradient(135deg, #059669, #10b981); border: none;">
                            + New
                        </a>
                    </div>
                </div>
        ...
        <div class="col-12 col-md-6 col-lg-4">
            <div class="card border-0 shadow-sm h-100 overflow-hidden d-flex flex-column bg-white" style="border-radius: 1.25rem; border: 1px solid #e2e8f0 !important; border-top: 4px solid #06b6d4 !important; transition: all 0.25s cubic-bezier(0.16, 1, 0.3, 1);">
                <div class="card-body p-4 d-flex flex-column">
                    ...
                    <div class="d-flex gap-2 mt-auto">
                        <a href="{{ route('air-waybills.index') }}" class="btn btn-outline-dark fw-bold flex-grow-1 py-2" style="border-radius: 0.65rem;">
                            Manage AWBs →
                        </a>
                        <a href="{{ route('air-waybills.create') }}" class="btn btn-info fw-bold px-3 py-2 text-white" style="border-radius: 0.65rem; background: linear-gradient(135deg, #0891b2, #06b6d4); border: none;">
                            + New
                        </a>
                    </div>
                </div>
        ...
        <div class="col-12 col-md-6 col-lg-4">
            <div class="card border-0 shadow-sm h-100 overflow-hidden d-flex flex-column bg-white" style="border-radius: 1.25rem; border: 1px solid #e2e8f0 !important; border-top: 4px solid #64748b !important; transition: all 0.25s cubic-bezier(0.16, 1, 0.3, 1);">
                <div class="card-body p-4 d-flex flex-column">
                    ...
                    <div class="d-flex gap-2 mt-auto">
                        <a href="{{ route('shipping-stickers.index') }}" class="btn btn-outline-dark fw-bold flex-grow-1 py-2" style="border-radius: 0.65rem;">
                            Manage Stickers →
                        </a>
                        <a href="{{ route('shipping-stickers.create') }}" class="btn btn-secondary fw-bold px-3 py-2" style="border-radius: 0.65rem;">
                            + New
                        </a>
                    </div>
                </div>
        ...
        <div class="col-12 col-md-6 col-lg-4">
            <div class="card border-0 shadow-sm h-100 overflow-hidden d-flex flex-column" style="border-radius: 1.25rem; border: 1px solid #e2e8f0 !important; border-top: 4px solid #0f172a !important; background: linear-gradient(135deg, #ffffff 0%, #f8fafc 100%); transition: all 0.25s cubic-bezier(0.16, 1, 0.3, 1);">
                <div class="card-body p-4 d-flex flex-column">
                    ...
                    <div class="d-flex gap-2 mt-auto">
                        <a href="{{ route('document-suite.health') }}" target="_blank" class="btn btn-outline-dark fw-bold w-100 py-2" style="border-radius: 0.65rem;">
    ...
    <div class="card border-0 shadow-sm overflow-hidden mb-4 bg-white" style="border-radius: 1.25rem; border: 1px solid #e2e8f0 !important;">
        <div class="card-header bg-white p-4 border-bottom d-flex flex-wrap align-items-center justify-content-between gap-3">
            ...
            <div style="min-width: 260px;">
                <input type="text" id="dashboardSearchInput" class="form-control form-control-sm rounded-pill px-3" placeholder="🔍 Quick Filter Feed..." onkeyup="filterDashboardTable()">
            </div>
        </div>
        <div class="card-body p-0">
            <div class="table-responsive">
                <table class="table table-hover align-middle mb-0" id="dashboardActivityTable">
                    ...
                    <tbody>
                        ...
                        <tr class="activity-row" data-search="{{ strtolower($item->type . ' ' . $item->number . ' ' . $item->party . ' ' . $item->date) }}">
                            <td class="ps-4 py-3.5">
                                <span class="badge {{ $item->badge }} rounded-pill px-3 py-1.5 fw-bold shadow-sm" style="font-size: 0.75rem;">
                                    <span class="me-1">{{ $item->icon }}</span> {{ $item->type }}
                                </span>
                            </td>
                            <td class="fw-bold text-dark py-3.5" style="font-size: 0.95rem;">{{ $item->number }}</td>
                            <td class="text-secondary fw-semibold py-3.5">{{ $item->party }}</td>
                            <td class="text-muted small py-3.5">{{ $item->date }}</td>
                            <td class="text-end pe-4 py-3.5">
                                <div class="btn-group shadow-sm" role="group">
                                    <a href="{{ $item->view_url }}" class="btn btn-sm btn-outline-primary fw-bold px-2.5" title="View Document">
                                        View
                                    </a>
                                    <a href="{{ $item->pdf_url }}" target="_blank" class="btn btn-sm btn-outline-danger fw-bold px-2.5" title="Download PDF">
                                        PDF
                                    </a>
                                    <a href="{{ $item->print_url }}" target="_blank" class="btn btn-sm btn-outline-dark fw-bold px-2.5" title="Print Document">
                                        Print
                                    </a>
                                </div>
                            </td>
...
function filterDashboardTable() {
    ...
    const rows = document.querySelectorAll('#dashboardActivityTable tbody tr.activity-row');

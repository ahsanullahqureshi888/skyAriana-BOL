        ...
        <div className="py-1">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-3">
            ...
            <div className="bg-gradient-to-br from-blue-50/60 via-white to-slate-50/50 p-3 rounded-xl border border-blue-200/80 shadow-2xs space-y-2">
              ...
              <div>
                <label className="text-[10.5px] font-bold text-blue-900 block mb-0.5">Description / Shipper / تفصیل</label>
                <Input
              ...
              <div className="grid grid-cols-2 gap-2">
                <div>
                  ...
                  <div className="flex items-center gap-1.5 mt-1">
                    ...
                    />
                    <label htmlFor="surrenderedBL_bol" className="text-[10px] text-blue-900 font-semibold cursor-pointer select-none">
                      Surrendered B/L
                    </label>
                  </div>
                </div>
